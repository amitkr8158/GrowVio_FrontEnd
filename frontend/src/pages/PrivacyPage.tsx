...
const PrivacyPage = () => (
  <div className="min-h-screen bg-background">
    ...
    <main className="max-w-2xl mx-auto px-6 py-12">
      <h1 className="font-display text-3xl font-bold text-ink-1 mb-2">Privacy Policy</h1>
      <p className="text-sm text-ink-3 mb-8">Updated April 2026</p>
      <div className="prose text-ink-2">
        <p>
          GrowVio is committed to protecting your privacy. We collect only the information
          necessary to provide our book summary service, including your name, email, and
          reading preferences. We do not sell your personal data to third parties.
        </p>
        <p className="mt-4">
